...
e=navigator.userAgent,h=null!==e.match(/iphone/i),p=null!==e.match(/android.*safari.*/i),D=null!==e.match(/android.*chrome.*/i),u=null!==e.match(/android.*firefox.*/i),T=/Kindle/i.test(e)||/Silk/i.test(e)||/KFTT/i.test(e)||/KFOT/i.test(e)||/KFJWA/i.test(e)||/KFJWI/i.test(e)||/KFSOWI/i.test(e)||/KFTHWA/i.test(e)||/KFTHWI/i.test(e)||/KFAPWA/i.test(e)||/KFAPWI/i.test(e),O=a("paste")?"paste":a("input")?"input":"propertychange",z=function(a,c,g){function d(a,l,f){l=l||0;var b=[],e,h=0,q;do{if(!0===a&&
c.validPositions[h]){var A=c.validPositions[h];q=A.match;e=A.locator.slice();b.push(null==q.fn?q.def:!0===f?A.input:q.placeholder||g.placeholder.charAt(h%g.placeholder.length))}else e=l>h?K(h,e,h-1)[0]:ca(h,e,h-1),q=e.match,e=e.locator.slice(),b.push(null==q.fn?q.def:void 0!=q.placeholder?q.placeholder:g.placeholder.charAt(h%g.placeholder.length));h++}while((void 0==M||h-1<M)&&null!=q.fn||null==q.fn&&""!=q.def||l>=h);b.pop();return b}function e(a){var l=c;l.buffer=void 0;l.tests={};!0!==a&&(l._buffer=
...
R(h,a.input,!0,!0):!1}if(!l)break}if(!l)return c.validPositions=f.extend(!0,{},b),!1}else c.validPositions[a]=l;return!0}function z(a,l){var b,g=a;for(b=a;b<l;b++)delete c.validPositions[b];for(b=l;b<=y();){var d=c.validPositions[b],f=c.validPositions[g];void 0!=d&&void 0==f?(ja(g,d.match.def)&&!1!==R(g,d.input,!0)&&(delete c.validPositions[b],b++),g++):b++}for(b=y();0<b&&(void 0==c.validPositions[b]||null==c.validPositions[b].match.fn);)delete c.validPositions[b],b--;e(!0)}function ca(a,b,d){a=K(a,
b,d);var e;b=y();b=c.validPositions[b]||K(0)[0];d=void 0!=b.alternation?b.locator[b.alternation].split(","):[];for(var h=0;h<a.length&&(e=a[h],!g.greedy&&(!e.match||!1!==e.match.optionality&&!1!==e.match.newBlockMarker||!0===e.match.optionalQuantifier||void 0!=b.alternation&&(void 0==e.locator[b.alternation]||-1!=f.inArray(e.locator[b.alternation].toString(),d))));h++);return e}function ga(a){return c.validPositions[a]?c.validPositions[a].match:K(a)[0].match}function ja(a,c){for(var b=!1,d=K(a),g=
0;g<d.length;g++)if(d[g].match&&d[g].match.def==c){b=!0;break}return b}function K(a,b,d){function e(b,d,l,h){function L(l,h,w){if(1E4<s)return alert("jquery.inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. "+c.mask),!0;if(s==a&&void 0==l.matches)return q.push({match:l,locator:h.reverse()}),!0;if(void 0!=l.matches)if(l.isGroup&&!0!==w){if(l=L(b.matches[k+1],h))return!0}else if(l.isOptional){var r=l;if(l=
e(l,d,h,w))l=q[q.length-1].match,(l=0==f.inArray(l,r.matches))&&(A=!0),s=a}else if(l.isAlternator){var r=l,n=[],x,ba=q.slice(),m=h.length,p=0<d.length?d.shift():-1;if(-1==p||"string"==typeof p){var sa=s,la=d.slice(),v;"string"==typeof p&&(v=p.split(","));for(var y=0;y<r.matches.length;y++){q=[];l=L(r.matches[y],[y].concat(h),w)||l;x=q.slice();s=sa;q=[];for(var z=0;z<la.length;z++)d[z]=la[z];for(z=0;z<x.length;z++)for(var X=x[z],u=0;u<n.length;u++){var ka=n[u];if(X.match.mask==ka.match.mask&&("string"!=
typeof p||-1!=f.inArray(X.locator[m].toString(),v))){n.splice(u,1);X.locator[m]=ka.locator[m]+","+X.locator[m];X.alternation=m;break}}n=n.concat(x)}"string"==typeof p&&(n=f.map(n,function(a,c){if(isFinite(c)){var b=a.locator[m].toString().split(","),d;a.locator[m]="";for(var U=0;U<b.length;U++)if(d=-1!=f.inArray(b[U],v))""!=a.locator[m]&&(a.locator[m]+=","),a.locator[m]+=b[U];if(""!=a.locator[m])return a}}));q=ba.concat(n);A=!0}else l=L(r.matches[p],[p].concat(h),w);if(l)return!0}else if(l.isQuantifier&&
!0!==w)for(r=l,g.greedy=g.greedy&&isFinite(r.quantifier.max),w=0<d.length&&!0!==w?d.shift():0;w<(isNaN(r.quantifier.max)?w+1:r.quantifier.max)&&s<=a;w++){if(n=b.matches[f.inArray(r,b.matches)-1],l=L(n,[w].concat(h),!0))if(l=q[q.length-1].match,l.optionalQuantifier=w>r.quantifier.min-1,l=0==f.inArray(l,n.matches))if(w>r.quantifier.min-1){A=!0;s=a;break}else return!0;else return!0}else{if(l=e(l,d,h,w))return!0}else s++}for(var k=0<d.length?d.shift():0;k<b.matches.length;k++)if(!0!==b.matches[k].isQuantifier){var w=
L(b.matches[k],[k].concat(l),h);if(w&&s==a)return w;if(s>a)break}}var h=c.maskToken,s=b?d:0;d=b||[0];var q=[],A=!1;if(void 0==b){b=a-1;for(var k;void 0==(k=c.validPositions[b])&&-1<b;)b--;if(void 0!=k&&-1<b)s=b,d=k.locator.slice();else{for(b=a-1;void 0==(k=c.tests[b])&&-1<b;)b--;void 0!=k&&-1<b&&(s=b,d=k[0].locator.slice())}}for(b=d.shift();b<h.length&&!(e(h[b],d,[b])&&s==a||s>a);b++);(0==q.length||A)&&q.push({match:{fn:null,cardinality:0,optionality:!0,casing:null,def:""},locator:[]});c.tests[a]=
...
b,d,h){function w(a,b,d,U){var l=!1;f.each(K(a),function(h,L){var q=L.match,A=b?1:0,s="";r();for(var w=q.cardinality;w>A;w--)s+=void 0==c.validPositions[a-(w-1)]?W(a-(w-1)):c.validPositions[a-(w-1)].input;b&&(s+=b);l=null!=q.fn?q.fn.test(s,c,a,d,g):b!=q.def&&b!=g.skipOptionalPartCharacter||""==q.def?!1:{c:q.def,pos:a};if(!1!==l){A=void 0!=l.c?l.c:b;A=A==g.skipOptionalPartCharacter&&null===q.fn?q.def:A;s=a;void 0!=l.remove&&z(l.remove,l.remove+1);if(l.refreshFromBuffer){s=l.refreshFromBuffer;d=!0;
da(!0===s?s:s.start,s.end);if(void 0==l.pos&&void 0==l.c)return l.pos=y(),!1;s=void 0!=l.pos?l.pos:a;if(s!=a)return l=f.extend(l,R(s,A,!0)),!1}else if(!0!==l&&void 0!=l.pos&&l.pos!=a&&(s=l.pos,da(a,s),s!=a))return l=f.extend(l,R(s,A,!0)),!1;if(!0!=l&&void 0==l.pos&&void 0==l.c)return!1;0<h&&e(!0);k(s,f.extend({},L,{input:ra(A,q)}),U)||(l=!1);return!1}});return l}d=!0===d;for(var s=r(),q=a-1;-1<q&&(!c.validPositions[q]||null!=c.validPositions[q].fn);q--)if((!n(q)||s[q]!=W(q))&&1<K(q).length){w(q,s[q],
!0);break}if(a>=S())return console.log("try alternate match"),!1;s=w(a,b,d,h);if(!d&&!1===s)if((q=c.validPositions[a])&&null==q.match.fn&&(q.match.def==b||b==g.skipOptionalPartCharacter))s={caret:E(a)};else if((g.insertMode||void 0==c.validPositions[E(a)])&&!n(a))for(var q=a+1,A=E(a);q<=A;q++)if(s=w(q,b,d,h),!1!==s){a=q;break}!0===s&&(s={pos:a});return s}function n(a){a=ga(a);return null!=a.fn?a.fn:!1}function S(){var a;M=m.prop("maxLength");-1==M&&(M=void 0);if(!1==g.greedy){var b;b=y();a=c.validPositions[b];
var d=void 0!=a?a.locator.slice():void 0;for(b+=1;void 0==a||null!=a.match.fn||null==a.match.fn&&""!=a.match.def;b++)a=ca(b,d,b-1),d=a.locator.slice();a=b}else a=r().length;return void 0==M||a<M?a:M}function E(a){var c=S();if(a>=c)return c;for(;++a<c&&!n(a)&&(!0!==g.nojumps||g.nojumpsThreshold>a););return a}function P(a){if(0>=a)return 0;for(;0<--a&&!n(a););return a}function F(a,c,b){a._valueSet(c.join(""));void 0!=b&&v(a,b)}function W(a,c){c=c||ga(a);return c.placeholder||(null==c.fn?c.def:g.placeholder.charAt(a%
...
ha(H().join(""))+")*$"),"")}function ia(a){if(a.data("_inputmask")&&!a.hasClass("hasDatepicker")){var b=[],d=c.validPositions,e;for(e in d)d[e].match&&null!=d[e].match.fn&&b.push(d[e].input);b=(C?b.reverse():b).join("");d=(C?r().reverse():r()).join("");f.isFunction(g.onUnMask)&&(b=g.onUnMask.call(a,d,b,g));return b}return a[0]._valueGet()}function N(a){!C||"number"!=typeof a||g.greedy&&""==g.placeholder||(a=r().length-a);return a}function v(a,c,b){a=a.jquery&&0<a.length?a[0]:a;if("number"==typeof c){c=
N(c);b=N(b);b="number"==typeof b?b:c;var d=f(a).data("_inputmask")||{};d.caret={begin:c,end:b};f(a).data("_inputmask",d);f(a).is(":visible")&&(a.scrollLeft=a.scrollWidth,!1==g.insertMode&&c==b&&b++,a.setSelectionRange?(a.selectionStart=c,a.selectionEnd=b):a.createTextRange&&(a=a.createTextRange(),a.collapse(!0),a.moveEnd("character",b),a.moveStart("character",c),a.select()))}else return d=f(a).data("_inputmask"),!f(a).is(":visible")&&d&&void 0!=d.caret?(c=d.caret.begin,b=d.caret.end):a.setSelectionRange?
(c=a.selectionStart,b=a.selectionEnd):document.selection&&document.selection.createRange&&(a=document.selection.createRange(),c=0-a.duplicate().moveStart("character",-1E5),b=c+a.text.length),c=N(c),b=N(b),{begin:c,end:b}}function ea(a){var b=r(),d=b.length,e,g=y(),h={},q=c.validPositions[g],k=void 0!=q?q.locator.slice():void 0,n;for(e=g+1;e<b.length;e++)n=ca(e,k,e-1),k=n.locator.slice(),h[e]=f.extend(!0,{},n);k=q&&void 0!=q.alternation?q.locator[q.alternation].split(","):[];for(e=d-1;e>g;e--)if(n=
...
e;for(k=0;k<T;k++)c+=")";c=RegExp("^("+c+")$");c=c.test(O)}else for(h=0,p=e.length;h<p;h++)if("\\"!=e.charAt(h)){c=u;c+=e.substr(0,h+1);c=c.replace(/\|$/,"");for(k=0;k<T;k++)c+=")";c=RegExp("^("+c+")$");if(c=c.test(O))break}u+=e}if(c)break}b&&(u+=")",T--);return c}null==e.regexTokens&&p();b=c.buffer.slice();var u="";c=!1;var T=0;b.splice(d,0,a);var O=b.join("");for(a=0;a<e.regexTokens.length&&!(h=e.regexTokens[a],c=D(h,h.isGroup));a++);return c},cardinality:1}}}})});
